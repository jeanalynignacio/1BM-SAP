...
<body>
    ...
    <div class="main--content">
        ...
        <div class="card--container">
            <h3 class="main--title"> Type of Financial Assistance 
                ...
                <li>
                    ...
                    <ul class = "dropdown">
                        <li> <a href = "#" onclick="medicines()"> Medicines </a></li>
        ...
        <div class="tabular--wrapper">
            ...
            <form id="assistance" action="http://localhost/1BM-SAP/assistance.php" method="POST">
...
$sql = "SELECT t.Date, b.Beneficiary_Id, b.Lastname, b.Firstname, b.CityMunicipality, t.Given_Sched, t.TransactionType,  t.Status , f.FA_Type 
...
function medicines(){
    window.location = "http://localhost/1BM-SAP/fa-medicines.php"
}

function burial(){
    window.location = "http://localhost/1BM-SAP/fa-burial.php"
}

function chemrad(){
    window.location = "http://localhost/1BM-SAP/fa-chemrad.php"
}

function dialysis(){
    window.location = "http://localhost/1BM-SAP/fa-dialysis.php"
}
function search() {
