...
$query ="INSERT INTO users( Lastname, Firstname, Middlename, Birthday, Contactnumber, Province, CityMunicipality, Barangay, HousenoStreet, Email, Username, Password) VALUES ('$Lastname', '$Firstname', '$Middlename', '$Birthday', '$Contactnumber', '$Province', '$CityMunicipality', '$Barangay', '$HousenoStreet', '$Email', '$Username', '$Password')";
...
?>
                ...
                <div class="field input">
                    ...
                    <p style="color:red;"><?php echo $brgyError ?></p>
                </div>
    ...
    window.onload = function () {
        populateBarangays();
                ...
                <div class="field input">
                    ...
                    <p style="color:red;"><?php echo $stError ?></p>
                  </div>
                <div class="field input">
