  ...
  $result=mysqli_query($con,$SQL);
   ...
   if(isset($_POST['update'])) {
    ...
    if(isset($_POST['confirmed']) && $_POST['confirmed'] === "yes") {
        ...
        // User cancelled, redirect to home.php
        header("Location: home.php");
        exit(); // Make sure to stop executing the script after redirecting
    }
}
        ...
        <div class="box form-box">
            ...
            <div class="field input">
                ...
                <div class="field input">
                    ...
                    <input type="text" name="Lastname" id="Lastname"  autocomplete="off" value="<?php echo "{$res_ID['Lastname']}"; ?>" >                  
                </div>
                <div class="field input">
                    <label for = "Firstname">First Name</label>
                    <input type="text" name="Firstname" id="Firstname" autocomplete="off"value="<?php echo "{$res_ID['Firstname']}"; ?>">                  
                </div>
                <div class="field input">
                    <label for = "Middlename">Middle Name</label>
                    <input type="text" name="Middlename" id="Middlename" autocomplete="off" value="<?php echo "{$res_ID['Middlename']}"; ?>">                  
                </div>
                <div class="field input">
                    <label for = "Birthday">Birthday</label>
                    <input type="date" name="Birthday" id="Birthday"value="<?php echo "{$res_ID['Birthday']}"; ?>">                  
                </div>
                <div class="field input">
                    <label for = "Contactnumber">Contact Number</label>
                    <input type="text" name="Contactnumber" id="Contactnumber" autocomplete="off"value="<?php echo "{$res_ID['Contactnumber']}"; ?>">
                </div>
                <div class="field input">
                    <label for = "Province">Province</label>
                    <input type="text" name="Province" id="Province" value="Bataan"value="<?php echo "{$res_ID['Middlename']}"; ?>">
                </div>
                <div class="field input">
    ...
    ?>
        ...
        barangayDropdown.value = selectedbrgy; 
                ...
                <div class="field input">
                    ...
                    <input type="text" name="HousenoStreet" id="HousenoStreet" autocomplete="off"value="<?php echo "{$res_ID['HousenoStreet']}"; ?>">                  
                </div>
                <div class="field input">
                ...
                <div class="field input">
                    ...
                    <input type="text" name="Username" id="Username" autocomplete="off"value="<?php echo "{$res_ID['Username']}"; ?>">                  
                </div>
                <div class="field input">
                    <label for = "Password">Password</label>
                    <input type="text" name="Password" id="Password" autocomplete="off"value="<?php echo "{$res_ID['Password']}"; ?>">                  
                </div>

                <input type="hidden" name="confirmed" id="confirmed" value="no">
                <div class="field">
                <input type="submit" class="btn"  name="update" value="Update" required  onclick="showConfirmation()" > 
